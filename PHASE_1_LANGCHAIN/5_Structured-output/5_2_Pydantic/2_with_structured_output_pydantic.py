...
review_text = """
Extract the review into one JSON object with exactly these keys:
key_themes, summary, sentiment, pros, cons, and name.
The sentiment must be one of: pos, neg, neutral.
Do not return an array, markdown, or any text outside the JSON object.
...
review_dictionary = review.model_dump()

# Pydantic object => JSON string
json = review.model_dump_json()
